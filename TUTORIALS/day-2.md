...
*-- You can clone the repository and checkout to the `day-2` branch to get the working code (we recommend not doing this so you learn by doing):*
```bash
...
Create an `src/agent.ts` file with the following content:
